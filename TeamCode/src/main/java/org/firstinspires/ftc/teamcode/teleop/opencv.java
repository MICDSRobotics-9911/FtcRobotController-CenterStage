...
public class opencv extends LinearOpMode {
    ...
    private VisionPortal controlHubCam;  // Use OpenCvCamera class from FTC SDK
    ...
    private void initOpenCV() {
        ...
        YellowBlobDetectionPipeline yellowBlob = new YellowBlobDetectionPipeline();
        controlHubCam = new VisionPortal.Builder()
    ...
    class YellowBlobDetectionPipeline implements VisionProcessor {
        ...
        public Mat processFrame(Mat frame, long captureTimeNanos) {
            ...
            Mat yellowMask = preprocessFrame(frame);

...
@Config
public class TestFlippedRedPipeline implements VisionProcessor, CameraStreamSource {
    ...
    private int colorspace = Imgproc.COLOR_RGB2HSV;
    public TestFlippedRedPipeline(Telemetry telemetry) {
    ...
    public Object processFrame(Mat frame, long captureTimeNanos) {
        ...
        Imgproc.cvtColor(frame, testMat, colorspace);
